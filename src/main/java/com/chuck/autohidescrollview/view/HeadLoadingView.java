...
public class HeadLoadingView extends LinearLayout implements ILoadingLayout {
    ...
    public void pullToRefresh() {
        ...
        mTitle.setText(getResources().getString(R.string.xscrollview_header_hint_normal));
    }
    ...
    public void releaseToRefresh() {
        ...
        mImageIsUp = true;
        mTitle.setText(getResources().getString(R.string.xscrollview_header_hint_ready));
    }
    ...
    public void refreshing() {
        ...
        mTitle.setText(getResources().getString(R.string.xscrollview_header_hint_loading));
